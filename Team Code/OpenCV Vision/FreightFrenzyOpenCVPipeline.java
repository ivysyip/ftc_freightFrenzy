...
public class FreightFrenzyOpenCVPipeline extends OpenCvPipeline
{
     ...
     */
    Point REGION1_TOPLEFT_ANCHOR_POINT = new Point(225, 420);
    Point REGION2_TOPLEFT_ANCHOR_POINT = new Point(680, 420);
    Point REGION3_TOPLEFT_ANCHOR_POINT = new Point(1080, 420);
    static final int REGION_WIDTH = 200;
    static final int REGION_HEIGHT = 280;
    ...
    public Mat processFrame(Mat input)
    {
        ...
        avg1 = (int) Core.mean(region2_Cb).val[0];
        avg2 = (int) Core.mean(region3_Cb).val[0];
         ...
         */
        int minOneTwo = Math.min(avg0, avg1);
        int min = Math.min(minOneTwo, avg2);
