...
//        static final int CB_CHAN_MASK_THRESHOLD = 80;
    ...
    static class AnalyzedBarcodes
    {
        Point[] points;
    }

    ArrayList<CameraImagePipeline.AnalyzedBarcodes> internalBarcodeList = new ArrayList<>();
    volatile ArrayList<CameraImagePipeline.AnalyzedBarcodes> clientBarcodeList = new ArrayList<>();
    ...
    CameraImagePipeline.Stage[] stages = CameraImagePipeline.Stage.values();
    ...
    public Mat processFrame(Mat input)
    {
        ...
        clientBarcodeList = new ArrayList<>(internalBarcodeList);
    ...
    public ArrayList<CameraImagePipeline.AnalyzedBarcodes> getDetectedBarcodes()
    {
    ...
    void analyzeContour(MatOfPoint contour, Mat input)
    {
        ...
        Point[] barcodePoints = new Point[4];

        // Do a rect fit to the contour, and draw it on the screen
        RotatedRect rotatedRectFitToContour = Imgproc.minAreaRect(contour2f);
        drawRect(rotatedRectFitToContour, input);
        rotatedRectFitToContour.points( barcodePoints );
        ...
        CameraImagePipeline.ContourRegionAnalysis aboveMidlineMetrics = analyzeContourRegion(aboveMidline);
        CameraImagePipeline.ContourRegionAnalysis belowMidlineMetrics = analyzeContourRegion(belowMidline);
        ...
        Point displOfOrientationLinePoint2 = computeDisplacementForSecondPointOfBarcodeOrientationLine(rotatedRectFitToContour, rotRectAngle);
        ...
        if(aboveMidlineMetrics.density < belowMidlineMetrics.density - DENSITY_UPRIGHT_THRESHOLD)
        {
            ...
            CameraImagePipeline.AnalyzedBarcodes analyzedBarcode = new CameraImagePipeline.AnalyzedBarcodes();
            analyzedBarcode.points = barcodePoints;
            internalBarcodeList.add(analyzedBarcode);
        }
    ...
    static CameraImagePipeline.ContourRegionAnalysis analyzeContourRegion(ArrayList<Point> contourPoints)
    {
        ...
        if(hullMatOfInt.toArray().length > 0)
        {
            ...
            CameraImagePipeline.ContourRegionAnalysis analysis = new CameraImagePipeline.ContourRegionAnalysis();
    ...
    static Point computeDisplacementForSecondPointOfBarcodeOrientationLine(RotatedRect rect, double unambiguousAngle)
    {
    ...
    static void drawRect(RotatedRect rect, Mat drawOn)
    {
        /*
